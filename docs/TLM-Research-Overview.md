...
I would especially value feedback from researchers in **networking and distributed systems**, in **mechanism and market design**, and in **quantitative finance**. The full development lives in our Vision and Foundation statements, the Related Work survey, and the research notes: RN-01 to RN-17 for the concept, the economics and the first mechanism proposals for Ethereum, and RN-26 and RN-33 applying the framework to a fast L1.
