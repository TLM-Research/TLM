...
RN-11 is the problem; this note is one mechanism for it and assumes it. RN-10 is the economics and the source of the two-camps account this note makes concrete. The lattice of quanta is RN-05; the reducibility constraint that makes an allocation checkable is RN-07; the demand representation (the decay function phi, the target tau, the tuple ECDF) is RN-01/02 and RN-11 sec. 5. References of the form "RN-11 sec. N" point to the problem note; internal references are to this note's own sections.
