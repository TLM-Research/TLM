...
| `rn21_basefee.py` | RN-21, *A Temporal Liquidity Fee Market Design for Ethereum* | secs. 5.1, 5.2 |
...
python3 tests/test_rn21_basefee.py
```
...
python3 rn21_basefee.py     > results/rn21_basefee.txt
```
